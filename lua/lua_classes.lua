classes = {
    ...
    item = {
        ...
        new = {
            ...
            { "itype_id", },
            { "itype_id", "time_point", },
            { "itype_id", "time_point", "long", },
            { "itype", },
            { "itype", "time_point", },
            { "itype", "time_point", "long", },
            { "itype_id", "time_point", "default_charges_tag", },
            { "itype", "time_point", "default_charges_tag", },
            { "itype_id", "time_point", "solitary_tag", },
            { "itype", "time_point", "solitary_tag", },
        },
        attributes = {
    ...
    item_location = {
        ...
        new = {
            ...
            { "map_cursor", "item", },
            { "map_cursor", "std::list< item >", },
            { "vehicle_cursor", "item", },
            { "vehicle_cursor", "std::list< item >", },
        },
        attributes = {
    ...
    player_activity = {
        ...
        new = {
            ...
            { "activity_id", "int", "int", "int", "std::string", },
            --{ "player_activity &&", },
            { "player_activity", },
        },
        attributes = {
    ...
    uilist = {
        ...
        new = {
            { },
            { "std::string", },
            { "std::string", "std::vector< uilist_entry >", },
            { "std::string", "std::vector< std::string >", },
            { "std::string", "std::initializer_list< char *>", },
            { "int", "int", "int", "std::string", "std::vector< uilist_entry >", },
            { "int", "int", "int", "std::string", "std::vector< std::string >", },
            { "int", "int", "int", "std::string", "std::initializer_list< char *>", },
        },
        attributes = {
